...
3. **Tradeoff - NAT Gateway Costs:** To pull public images while keeping the nodes in private subnets, we had to provision a NAT Gateway in the public subnet. While this ensures outbound-only internet access, it introduces a permanent cost overhead.
